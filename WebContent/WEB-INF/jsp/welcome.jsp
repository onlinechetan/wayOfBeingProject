...
<td></td>
    <td>Survey Question</td>
	    ...
	    <td>Somewhat Infrequently</td>
	    <td>Somewhat Frequently</td>
  ...
  <td>1</td>
    ...
    <td>I value getting things done over finding deeper purpose (i.e. meaning) in what I am doing.</td>
	    <td><input type="radio" name="choice" value="AmostAlways"></td>
	    <td><input type="radio" name="choice" value="VeryFrequently"></td>
	    <td><input type="radio" name="choice" value="SomewhatInfrequently"></td>
	    <td><input type="radio" name="choice" value="SomewhatFrequently"></td>
	    <td><input type="radio" name="choice" value="VeryInfrequently"></td>
	    <td><input type="radio" name="choice" value="AlmostNever"></td>
  </tr>
